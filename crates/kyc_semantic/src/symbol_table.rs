...
impl SymbolTable {
    ...
    fn register_builtins(&mut self) {
        ...
        let runtime_fns = [
            ...
            "ky_log_debug", "ky_log_info", "ky_log_warn", "ky_log_error",
            "ky_log_set_level", "ky_log_set_output", "ky_log_set_console",
            ...
            "ky_bytes_from_base64",
            "ky_bytes_to_be_i32", "ky_bytes_to_le_i32",
            "ky_bytes_to_be_i64", "ky_bytes_to_le_i64",
            "ky_bytes_from_be_i32", "ky_bytes_from_le_i32",
            "ky_bytes_from_be_i64", "ky_bytes_from_le_i64",
            "ky_bytes_from_be_i32_at", "ky_bytes_from_be_i64_at",
            "ky_buffer_new", "ky_buffer_free", "ky_buffer_len",
            "ky_buffer_write_byte", "ky_buffer_write_be_i32", "ky_buffer_write_le_i32",
            "ky_buffer_write_be_i64", "ky_buffer_write_le_i64",
            "ky_buffer_write_str", "ky_buffer_to_bytes", "ky_buffer_clear",
            ...
            "ky_url_new", "ky_url_parse", "ky_url_free",
            "ky_url_to_str", "ky_url_get_scheme", "ky_url_get_host",
            "ky_url_get_port", "ky_url_get_path", "ky_url_get_query",
            "ky_url_get_fragment", "ky_url_get_userinfo", "ky_url_get_query_value",
            "ky_url_set_scheme", "ky_url_set_host", "ky_url_set_port",
            "ky_url_set_path", "ky_url_set_query",
            "ky_url_encode", "ky_url_decode",
